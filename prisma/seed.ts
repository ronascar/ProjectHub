...
async function main() {
    ...
    const project1 = await prisma.project.create({
        data: {
            ...
            description: 'Projeto de modernização da identidade visual e arquitetura do site da Acme Corp. Inclui migração do legado WordPress para uma arquitetura Headless moderna.',
    ...
    const project2 = await prisma.project.create({
        data: {
            ...
            description: 'Desenvolvimento de aplicativo mobile para plataforma de e-commerce. Versões iOS e Android com funcionalidades de catálogo, carrinho e pagamento.',
    ...
    const project3 = await prisma.project.create({
        data: {
            ...
            description: 'Sistema de dashboard para visualização de métricas e KPIs em tempo real. Integração com múltiplas fontes de dados.',
    ...
    const tasks = await Promise.all([
        prisma.task.create({
            data: {
                ...
                description: 'Atualizar o fluxo de autenticação para suportar OAuth2.0 com Google e GitHub.',
                status: 'IN_PROGRESS',
                priority: 'HIGH',
        ...
        prisma.task.create({
            data: {
                ...
                description: 'Implementar integração com Stripe para processamento de pagamentos.',
                status: 'IN_PROGRESS',
                priority: 'HIGH',
